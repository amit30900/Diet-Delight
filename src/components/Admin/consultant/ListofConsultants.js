...
import { setConsultant, resetConsultant, selectConsultant } from '../../../features/adminSlice'
...
const ListofConsultants = () => {
    ...
    useEffect(() => {
        axios.get(`consultants?pageSize=${page}&search=${search}&sortBy=${sort}&sortOrder=${order}`, {
            headers: {
    ...
    return (
        <>
                ...
                <DialogContent>
                    <Mini>
                        <Button variant="contained" color="secondary"
                            onClick={() => {
                                axios.delete(`consultants/${consultant.id}`).then(
                                    (res) => {
                                        setIsSuccess(true)
                                        setIsDelete(false)
                                        handleShow()
            ...
            >
                ...
                <DialogContent>
                    <Formik
                        ...
                        onSubmit={(values) => {
                            axios.put(`consultants/${consultant.id}`, {
                                name: values.name,
            ...
            {loading ? (<CustomSkeleton />) : (<>
                <Main>
                    <h3 style={{ textAlign: "left", marginLeft: "50px", marginBottom: "20px" }}>List of Consultants</h3>
                    <HContainer>
                        <Con>
